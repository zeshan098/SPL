  ...
  border-collapse: collapse;
    ...
    <div class="row">
        ...
        <div class="box-header with-border">
            ...
            <hr> 
            <!-- <div class="12th">
                <span class="input-group-addon">ZM Remarks: {{ $view_case->zm_remarks }}</span>
                <hr>
            ...
            <div class="7th">
                ...
                <div class="13th">
                    ...
                    <!-- <span><input type="text" class="form-control" size="56" value="{{ $view_case->nsm_remarks }}" placeholder="Designation" readonly /></span> -->
                </div>
                <br />
            ...
            <div class="12th">
                ...
                <!-- <span class="input-group-addon">ZM Remarks: {{ $view_case->zm_remarks }}</span> -->
                <span style="position:absolute" class="input-group-addon">Last Visit Date:</span>
                 
                <span style="position:absolute; left:100px;"><input type="text"  name="vehicle1" value="{{ $view_case->pm_last_visit_date }}"></span>
                <span style="position:absolute;left:470px;"class="input-group-addon">Status:</span>

                <span style="position:absolute;left:517px;"><input type="text" name="vehicle1" value=""></span>
                <br /><br />
                <hr>
            </div>

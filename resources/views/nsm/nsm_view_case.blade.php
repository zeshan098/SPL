            ...
            <div class="form-horizontal">
              ...
              <div class="row"> 
                ...
                <h3>Rentention Case Details (In case of Retention)</h3>
                    ...
                    <div class="col-md-12 col-lg-12">
                        <div class="input-group">
                            <a href="{{route('nsm.retention_documents',$retention_document->id)}}" class="btn btn-outline-warning"><i class="fa fa-fw fa-download"></i>Download</a>
                        </div>
                    </div>
                ...
                @foreach($case_document as $case_document)
                        ...
                        <div class="col-md-12 col-lg-12">
                            <div class="input-group"> 
                                <a href="{{route('nsm.download_documents',$case_document->id)}}" class="btn btn-outline-warning"><i class="fa fa-fw fa-download"></i>Download</a>
                            </div>
                        </div>

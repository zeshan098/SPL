            ...
            <div class="box">
                ...
                <!--<div class="box-body table-responsive no-padding">-->
                    <table id="users_list" class="table table-bordered table-striped">
                        ...
                        <tbody>
                        @foreach($nsm_case_record as $case_record)
                            <tr>
                                ...
                                @if(  $case_record->pmccrsid == null)
                                    <td> Waiting For Approval </td>
                                @elseif($case_record->is_completed == 1)
                                <td> Approved </td>
                                @endif
                                <td><a href="{{route('nsm.view_case',$case_record->id)}}">View Case</a> | <a href="{{route('nsm.generate-pdf',$case_record->id)}}">PDF</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                        <!-- <tfoot>

    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <div class="box">
                            ...
                            <!--<div class="box-body table-responsive no-padding">-->
                                <table id="users_list" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                    @foreach($nsm_absent_record as $nsm_absent_record)
                                        <tr>
                                            <td style="display:none">YYYY/mm/dd</td>
                                            <td>{{ $nsm_absent_record->from_date }}</td>
                                            <td>{{ $nsm_absent_record->to_date }}</td> 
                                            <td>{{ $nsm_absent_record->absent_ccrsid }}</td>
                                            <td>{{ $nsm_absent_record->assign_ccrsid }}</td>
                ...
                <!-- form start -->
                <form method="post" action="{{ route('nsm.nsm_absents') }}">

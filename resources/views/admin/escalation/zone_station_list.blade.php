        ...
        <div class="col-xs-12">
            <div class="box">
                <div class="box-header">
                    <h3 class="box-title">Zone Station List</h3>
                </div>
                <!-- /.box-header -->
                    ...
                    <table id="users_list" class="table table-bordered table-striped">
                        ...
                        @foreach($zone_list as $zone_list)
                            <tr>
                                ...
                                <td>{{ $zone_list->ccrsid}}</td>
                                <td>{{ $zone_list->team }}</td>
                                <td>{{ $zone_list->zone }}</td>
                                <td>{{ $zone_list->district }}</td>
                                <td>{{ $zone_list->station }}</td>
                                <td>{{ $zone_list->role }}</td>  

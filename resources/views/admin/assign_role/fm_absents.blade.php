                    ...
                    <div class="box-body">
                       <div class="form-group">
                            ...
                            <select name="absent_ccrsid" class="form-control select2" required>
                                    ...
                                    @foreach ($fm_escalation_record as $fm_escalation_record) {
                                        <option value="{{ $fm_escalation_record->fmccrsid }}">{{ $fm_escalation_record->fmccrsid }}</option>
                                    @endforeach
...
$("select[name='absent_ccrsid']").on('change', function(){
      var fm_ccrsid = $(this).val();
      console.log(fm_ccrsid);
      var token = $("input[name='_token']").val();
      $.ajax({
          url: "<?php echo url('admin/findZm') ?>",
          method: 'POST',
          data: {fm_ccrsid:fm_ccrsid, _token:token},

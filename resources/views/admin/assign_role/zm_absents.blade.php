    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="box box-primary">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="post" action="{{ url('admin/zm_absent') }}">
                    ...
                    <div class="box-body">
                       <div class="form-group">
                            ...
                            <select name="absent_ccrsid" class="form-control select2" required>
                                    ...
                                    @foreach ($zm_escalation_record as $zm_escalation_record) {
                                        <option value="{{ $zm_escalation_record}}">{{ $zm_escalation_record}}</option>
                                    @endforeach
...
$("select[name='absent_ccrsid']").on('change', function(){
      var zm_ccrsid = $(this).val();
      console.log(zm_ccrsid);
      var token = $("input[name='_token']").val();
      $.ajax({
          url: "<?php echo url('admin/findFm') ?>",
          method: 'POST',
          data: {zm_ccrsid:zm_ccrsid, _token:token},

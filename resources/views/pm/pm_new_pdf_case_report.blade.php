    ...
    <div class="row">
        ...
        <div class="box box-info">
            ...
            <div class="7th">
                ...
                <hr>
                <div class="13th">
                    <span class="input-group-addon">NSM Remarks:</span>
                    <span><input type="text" class="form-control" size="54" value="{{ $view_case->nsm_remarks }}" placeholder="Designation" readonly /></span>
                </div>
                <br />
            ...
            <div style="border:1px solid black; padding:10px; margin-bottom:5px;">
              <div style="position:relative;left:1px; margin-bottom:3px;" class="input-group-addon">SM&MM:</div>
                <span style="position:absolute" class="input-group-addon">Reject:</span>

                <span style="position:absolute; left:60px;"><input type="checkbox"  name="vehicle1" value="Reject"></span>
                <span style="position:absolute;left:325px;" class="input-group-addon">Deffered:</span>

                <span style="position:absolute;left:385px;"><input type="checkbox" name="vehicle1" value="Reject"></span>
                <span style="position:absolute;left:550px;"class="input-group-addon">Approved:</span>

                <span style="position:absolute;left:617px;"><input type="checkbox" name="vehicle1" value="Reject"></span>
                 <br/><br/>
                <span class="input-group-addon">Amount:</span>
                <!-- <span><input type="text" class="form-control fields"  readonly /></span> -->
                <span class="input-group-addon" style="position:absolute;left:322px;">Signature:</span>
                <!-- <span style="position:absolute;left:350px;"><input type="text" class="form-control"  readonly /></span> -->
                
                <span class="input-group-addon" style="position:absolute;left:545px;">Date:</span>
            ...
            <div class="14th">
            <div style="border:1px solid black; padding:10px; margin-bottom:5px;">
              <div style="position:relative;left:1px; margin-bottom:3px;" class="input-group-addon">Director:</div>
                <span style="position:absolute" class="input-group-addon">Reject:</span>

    ...
    <div class="row">
        ...
        <div class="box box-info">
            ...
            <div class="7th">
                ...
                <span><input type="text" style="text-align:right; font-size:12px;" class="form-control" size="12" value="{{ $view_case->zm_approved_date }}" placeholder="Hospital Name" readonly /></span>
                
                <span class="input-group-addon" style="font-size:12px;">Last Visit Date:</span>
                <span><input type="text" style="text-align:right; font-size:12px;" class="form-control" size="12" value="{{ $view_case->zm_last_visit_date }}" placeholder="Hospital Name" readonly /></span>
                 -->
            ...
            <div style="border:1px solid black; padding:10px; margin-bottom:3px;">
              <div style="position:relative;left:1px; margin-bottom:3px;font-size:13px;;font-weight:bold;" class="input-group-addon">DIRECTOR:</div>
                ...
                <span style="position:absolute;left:617px;"><input type="checkbox" style="font-size: x-medium;" name="vehicle1" value="Reject"></span>
                 <br/> <br/>
                 @if($view_case->is_approved_pm != 0)
                <span class="input-group-addon" style="font-size:12px;">Amount:</span>
                <span><input type="text" value="{{$view_case->approved_amount}}" class="form-control fields"  readonly /></span>
                @else
                <span class="input-group-addon" style="font-size:12px;">Amount:</span>

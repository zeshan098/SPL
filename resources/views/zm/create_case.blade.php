...
<section class="content main_calculations">
    <!--tab1 -->
    <form method="post" onsubmit="return confirm('Do you really want to submit the form?');" action="{{ route('zm.store') }}" enctype="multipart/form-data">
                ...
                <div class="box tab" id="box tab">
                    ...
                    <div class="box-body">
                      <div class="row">
                            <div class="col-xs-12">
                                <div class="form-group">
                                    <label>FMCCRSID</label>
                                     
                                    <input class="form-control" id="" type="text" name="fmccrsid"  value="{{ $fmccrsid }}"  readonly>
                    ...
                    <div class="box-body">
                        <div class="row">
                            <div class="col-xs-12">
                                ...
                                <select name="qualification_id" class="form-control select2" required>
...
<!-- <script type="text/javascript"> 
  $("select[name='station']").change(function(){
      ...
      var token = $("input[name='_token']").val();
      $.ajax({
          url: "<?php echo route('zm.dr_detail') ?>",
          method: 'POST',
...
$("select[name='dr_designation']").on('change', function(){
      ...
      var token = $("input[name='_token']").val();
      $.ajax({
          url: "<?php echo route('zm.designation_show') ?>",
          method: 'POST',
...
$("select[name='dr_name']").change(function(){
      ...
      var token = $("input[name='_token']").val();
      $.ajax({
          url: "<?php echo route('zm.rejected_case_check') ?>",
          method: 'POST',
          data: {dr_name:dr_name, _token:token},
          success: function(data) {
            console.log(data);

...
<section class="content">
    ...
    <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" onsubmit="return confirm('Do you really want to submit the form?');" action="{{ route('zm.update_nsm', $case_view->id) }}">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control pull-right datepicker"
                                       name="nsm_last_visit_date" autocomplete="off" id="datepicker" >
                </div>

...
<section class="content">
    ...
    <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form method="post" onsubmit="return confirm('Do you really want to submit the form?');" action="{{ route('zm.update', $case_view->id) }}" id="id_frm">
              ...
              <div class="box-footer">
                ...
                <a href="{{route('zm.view_case',$case_view->id)}}" class="btn btn-primary">View Case</a>
                <a href="{{route('zm.generate-pdf',$case_view->id)}}" class="btn btn-primary">PDF View Case</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
...
<script src="{{ asset("bower_components/datepicker/daterangepicker.js") }}"></script><!--selectjs-->

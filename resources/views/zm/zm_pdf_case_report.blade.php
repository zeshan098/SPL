        ...
        <div class="box box-info">
            ...
            <div class="7th">
                ...
                @foreach($zm_name as $zm_name)
                  <input type="text"  class="form-control" style="font-size:12px;" size="16" value="{{ $zm_name->name }}" placeholder="Designation" readonly /></span>
                @endforeach
                ...
                <div class="7th">
                    ...
                    <span><input type="text" style=" font-size:12px;" class="form-control" size="18" value="{{ $view_case->nsm_approved_date ? date('d/m/Y', strtotime($view_case->nsm_approved_date)) : ''}}" placeholder="Hospital Name" readonly /></span>
